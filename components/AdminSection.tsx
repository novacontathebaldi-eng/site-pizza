            ...
            <section id="admin" className="py-20 bg-brand-ivory-50">
                <div className="container mx-auto px-4">
                    <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                        ...
                        {activeTab === 'promotions' && <PromotionsTab allProducts={allProducts} promotions={promotions} onSave={onSavePromotion} onDelete={onDeletePromotion} onReorder={onReorderPromotions} siteSettings={siteSettings} onSaveSettings={onSaveSiteSettings} />}
                        ...
                        {activeTab === 'settings' && (
                            <div>
                                ...
                                <div className="bg-red-50 p-4 rounded-lg border border-red-200 mt-4">
                                    <h4 className="font-semibold text-lg mb-2 text-red-800"><i className="fas fa-undo mr-2"></i>Restaurar Padrões</h4>
                                    ...
                                    <button onClick={onRestoreDefaults} className="bg-red-500 text-white font-semibold py-2 px-4 rounded-lg hover:bg-red-600">Restaurar Configurações Padrão</button>
                                </div>
                                </div> )}
                            </div>
                        )}
