                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
                    <div className="flex flex-col items-center md:items-start md:col-span-1">
                        <div className="flex items-center gap-3 text-2xl font-bold mb-4">
                           {siteContent?.logoUrl && <img src={siteContent.logoUrl} alt="Santa Sensação Logo" className="h-12" />}
                            <span>{siteContent?.headerTitle ? siteContent.headerTitle.replace('Pizzaria ', '') : 'Santa Sensação'}</span>
                        </div>
                        <p className="text-brand-green-300 mb-4">{siteContent?.heroBadge} 🏅</p>
