            ...
            case 'register':
                return (
                    <>
                        ...
                        <div className="relative my-6"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-200"></div></div><div className="relative flex justify-center text-sm"><span className="px-3 bg-white text-gray-500 font-medium">ou</span></div></div>
                        <button type="button" onClick={onGoogleSignIn} disabled={isLoading} className="w-full bg-brand-green-700 text-white font-semibold text-base py-3 px-4 rounded-xl hover:bg-[#224A2A] hover:shadow-[0_4px_15px_rgba(44,86,51,0.4)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-3 shadow-md disabled:opacity-70 disabled:cursor-not-allowed">
                            <div className="bg-white p-1 rounded-full flex items-center justify-center transition-colors">
