        ...
        <div className="fixed bottom-0 left-0 right-0 bg-brand-green-700 text-white p-4 z-50 shadow-lg animate-fade-in-up">
            <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-sm text-center sm:text-left">
                    ...
                    Nosso site utiliza cookies essenciais para garantir o bom funcionamento do carrinho de compras e da sua conta. Ao continuar navegando, você concorda com nosso uso de cookies.
                </p>
                <button 
                    onClick={onAccept}
