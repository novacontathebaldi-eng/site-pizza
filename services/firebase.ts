...
try {
  // FIX: The original named import for `initializeApp` and `FirebaseApp` was failing.
  // Using a namespace import (`* as firebaseApp`) is a robust workaround for module resolution issues
  // often seen with Firebase v9 in certain build environments.
