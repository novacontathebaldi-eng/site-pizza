...
var getExperimentalSetting = (name3) => {
  var _a;
  return (_a = getDefaults()) == null ? void 0 : _a[`_${name3}`];
};
var Deferred = class {
  constructor() {
    this.reject = () => {
...
var FirebaseAppImpl2 = class {
  ...
  _getService(name3, instanceIdentifier = DEFAULT_ENTRY_NAME2) {
    ...
    if (!provider.isInitialized() && ((_a = provider.getComponent()) == null ? void 0 : _a.instantiationMode) === "EXPLICIT") {
      provider.initialize();
    }
...
@firebase/app-compat/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MKNX2FU5.js.map
