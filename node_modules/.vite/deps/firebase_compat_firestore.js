...
// node_modules/@firebase/firestore-compat/dist/index.esm.js
...
var FirestoreDataConverter = class _FirestoreDataConverter {
  ...
  fromFirestore(snapshot, options) {
    ...
    return this._delegate.fromFirestore(new QueryDocumentSnapshot2(this._firestore, expSnapshot), options ?? {});
  }
...
var DocumentReference2 = class _DocumentReference {
  ...
  get(options) {
    let snap;
    if ((options == null ? void 0 : options.source) === "cache") {
      snap = getDocFromCache(this._delegate);
    } else if ((options == null ? void 0 : options.source) === "server") {
...
function wrapObserver(args, wrapper) {
  ...
  return {
    ...
    error: (_a = userObserver.error) == null ? void 0 : _a.bind(userObserver),
    complete: (_b = userObserver.complete) == null ? void 0 : _b.bind(userObserver)
  };
}
