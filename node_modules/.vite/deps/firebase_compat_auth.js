...
async function getIdTokenResult(user, forceRefresh = false) {
  ...
  const signInProvider = firebase2 == null ? void 0 : firebase2["sign_in_provider"];
  return {
    claims,
    token,
    ...
    signInSecondFactor: (firebase2 == null ? void 0 : firebase2["sign_in_second_factor"]) || null
  };
}
  ...
  try {
    await new Promise((resolve, reject) => {
      ...
      function authEventSeen() {
        var _a;
        resolve();
        const closeBrowserTab = (_a = cordova.plugins.browsertab) == null ? void 0 : _a.close;
        if (typeof closeBrowserTab === "function") {
          closeBrowserTab();
        }
        if (typeof (iabRef == null ? void 0 : iabRef.close) === "function") {
          iabRef.close();
        }
      }
      function resumed() {
...
function _checkCordovaConfiguration(auth) {
  ...
  _assert(typeof ((_a = win == null ? void 0 : win.universalLinks) == null ? void 0 : _a.subscribe) === "function", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-universal-links-plugin-fix"
  });
  _assert(typeof ((_b = win == null ? void 0 : win.BuildInfo) == null ? void 0 : _b.packageName) !== "undefined", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-plugin-buildInfo"
  });
  _assert(typeof ((_e = (_d = (_c = win == null ? void 0 : win.cordova) == null ? void 0 : _c.plugins) == null ? void 0 : _d.browsertab) == null ? void 0 : _e.openUrl) === "function", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-plugin-browsertab"
  });
  _assert(typeof ((_h = (_g = (_f = win == null ? void 0 : win.cordova) == null ? void 0 : _f.plugins) == null ? void 0 : _g.browsertab) == null ? void 0 : _h.isAvailable) === "function", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-plugin-browsertab"
  });
  _assert(typeof ((_j = (_i = win == null ? void 0 : win.cordova) == null ? void 0 : _i.InAppBrowser) == null ? void 0 : _j.open) === "function", auth, "invalid-cordova-configuration", {
...
function _eventFromPartialAndUrl(partialEvent, url) {
  ...
  if (callbackUrl.includes("/__/auth/callback")) {
    ...
    const code = (_b = (_a = errorObject == null ? void 0 : errorObject["code"]) == null ? void 0 : _a.split("auth/")) == null ? void 0 : _b[1];
...
var CordovaPopupRedirectResolver = class {
  ...
  attachCallbackListeners(auth, manager) {
    ...
    const universalLinksCb = async (eventData) => {
      ...
      let finalEvent = null;
      if (partialEvent && (eventData == null ? void 0 : eventData["url"])) {
...
function _getCurrentScheme2() {
  var _a;
  return ((_a = self == null ? void 0 : self.location) == null ? void 0 : _a.protocol) || null;
}
...
function _isIe11() {
  return isIE() && (document == null ? void 0 : document.documentMode) === 11;
}
...
function getSessionStorageIfAvailable() {
  var _a;
  try {
    return ((_a = _getSelfWindow()) == null ? void 0 : _a.sessionStorage) || null;
  } catch (e) {
    return null;
  }
}
...
function attachExtraErrorFields(auth, e) {
  var _a;
  const response = (_a = e.customData) == null ? void 0 : _a._tokenResponse;
  if ((e == null ? void 0 : e.code) === "auth/multi-factor-auth-required") {
    const mfaErr = e;
...
var RecaptchaVerifier2 = class {
  constructor(container, parameters, app = firebase.app()) {
    var _a;
    _assert2((_a = app.options) == null ? void 0 : _a.apiKey, "invalid-api-key", {
      appName: app.name
    });
