...
exports.askSanto = onCall({secrets}, async (request) => {
  ...
  try {
    ...
    const timeInstruction = `INFORMAÇÃO DE CONTEXTO EM TEMPO REAL: A data e hora atual são ${brasiliaTime}. Use esta informação de forma natural para responder sobre horários. Por exemplo, se forem 20h, diga 'são 8 da noite' ou 'são 20h'. Se for de manhã, dê um 'bom dia!'. Seja criativo e adequado ao momento.`;
